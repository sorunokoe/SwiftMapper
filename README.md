...
```
"... That is, you’re not really writing precise instructions to solve the problem;
It’s more like you’re describing the problem in the language, and then it goes and solves it for you."
```
